...
var _renderTableJs = require("./view/renderTable.js");
var _renderTableJsDefault = parcelHelpers.interopDefault(_renderTableJs);
var _renderOptViewJs = require("./view/renderOptView.js");
var _renderOptViewJsDefault = parcelHelpers.interopDefault(_renderOptViewJs);
var _renderResultJs = require("./view/renderResult.js");
var _renderResultJsDefault = parcelHelpers.interopDefault(_renderResultJs);
...
const renderStudentsData = async function(filterOpt) {
    try {
        await _modelJs.fetchData();
        (0, _renderTableJsDefault.default).render(_modelJs.datas.students);
    } catch (err) {
        console.error(err);
    }
};
const renderFormOpt = async function() {
    try {
        await _modelJs.fetchFormOpt();
        (0, _renderOptViewJsDefault.default).render(_modelJs.datas.ages, selectAge);
        (0, _renderOptViewJsDefault.default).render(_modelJs.datas.genders, selectGender);
        (0, _renderOptViewJsDefault.default).render(_modelJs.datas.states, selectState);
        (0, _renderOptViewJsDefault.default).render(_modelJs.datas.levels, selectLevel);
    } catch (err) {
        console.error(err);
    }
};
const renderFilterData = async function(el) {
    try {
        ...
        if (!fil.length) {
            (0, _renderResultJsDefault.default).renderError(_modelJs.datas.filterError);
            return (0, _renderTableJsDefault.default).render(_modelJs.datas.students);
        }
        await _modelJs.fetchData();
        const filtered = _modelJs.filterByOpt(_modelJs.datas.students, fil);
        (0, _renderTableJsDefault.default).render(filtered);
        form.reset();
    } catch (err) {
        (0, _renderResultJsDefault.default).renderError(err);
    }
};
const renderStudentResult = function(e) {
    ...
    if (!btn) return;
    console.log(btn);
    (0, _renderResultJsDefault.default).render(_modelJs.datas.filterResults, body);
...
},{"./model.js":"Py0LO","./view/renderTable.js":"eiJbO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./view/renderOptView.js":"8De9G","./view/renderResult.js":"hUeNc"}],"Py0LO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "datas", ()=>datas);
parcelHelpers.export(exports, "fetchData", ()=>fetchData);
parcelHelpers.export(exports, "fetchFormOpt", ()=>fetchFormOpt);
parcelHelpers.export(exports, "filterByOpt", ()=>filterByOpt);
parcelHelpers.export(exports, "fetchPostRequest", ()=>fetchPostRequest);
parcelHelpers.export(exports, "fetchFilterResult", ()=>fetchFilterResult);
...
const fetchData = async function() {
    try {
        const data = await (0, _helperJs.AJAX)((0, _configJs.ALLSTUDENTDATA));
        datas.students = data.data.students;
    } catch (err) {
        throw err;
    }
};
const fetchFormOpt = async function() {
    try {
        const data1 = await (0, _helperJs.AJAX)((0, _configJs.ALLAGES));
        const data2 = await (0, _helperJs.AJAX)((0, _configJs.ALLEVELS));
        const data3 = await (0, _helperJs.AJAX)((0, _configJs.ALLSTATES));
...
const filterByOpt = function(arr, keys) {
    const res = arr.filter((obj)=>keys.every((term)=>Object.values(obj).includes(term)));
    return res;
};
const fetchPostRequest = async function() {
    try {
        let request = await (0, _helperJs.sendJSON)((0, _configJs.VIEWRESULT));
...
const fetchFilterResult = async function() {
    try {
        const request = await (0, _helperJs.sendJSON)((0, _configJs.FILTERDATA));
...
},{"./config.js":"4Wc5b","./helper.js":"6fitd","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ"}],"4Wc5b":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ALLSTUDENTDATA", ()=>ALLSTUDENTDATA);
parcelHelpers.export(exports, "ALLEVELS", ()=>ALLEVELS);
parcelHelpers.export(exports, "ALLSTATES", ()=>ALLSTATES);
parcelHelpers.export(exports, "ALLAGES", ()=>ALLAGES);
parcelHelpers.export(exports, "FILTERDATA", ()=>FILTERDATA);
parcelHelpers.export(exports, "VIEWRESULT", ()=>VIEWRESULT);
const ALLSTUDENTDATA = "https://test.omniswift.com.ng/api/viewAllData";
const ALLEVELS = "https://test.omniswift.com.ng/api/viewAllLevels";
const ALLSTATES = "https://test.omniswift.com.ng/api/viewAllStates";
const ALLAGES = "https://test.omniswift.com.ng/api/viewAllAges";
const FILTERDATA = "https://test.omniswift.com.ng/api/filterData";
const VIEWRESULT = "https://test.omniswift.com.ng/api/viewResult/2"; /*
GET - All Data
...
GET - All Ages
https://test.omniswift.com.ng/api/viewAllAges
...
},{}],"eiJbO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new RenderTableData();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8De9G":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new RenderTableOpt();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hUeNc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class RenderResult {
    _data;
    ...
    <main>
      ...
      <div class="result-table tables margin-bottom">
        <table class="customTable result margin-bottom">
          ...
          <tbody class="student-data">${this._data.result.map((d, index)=>{
            return `
            <tr class="grayish">
...
exports.default = new RenderResult();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["csuDB","bDbGG"], "bDbGG", "parcelRequireb58e")
